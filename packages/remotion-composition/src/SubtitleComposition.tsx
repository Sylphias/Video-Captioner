...
export function SubtitleComposition({ videoSrc, phrases, style, speakerStyles, animationPreset, showSpeakerBorders, phraseLaneOverrides, laneCount, speakerHighlightDisabled }: SubtitleCompositionProps) {
    ...
    <AbsoluteFill style={{ backgroundColor: 'black' }}>
      ...
      <AbsoluteFill>
        <SubtitleOverlay
          ...
          phraseLaneOverrides={phraseLaneOverrides}
          laneCount={laneCount}
          speakerHighlightDisabled={speakerHighlightDisabled}
        />
      </AbsoluteFill>
    </AbsoluteFill>
  )

...
export function SubtitleComposition({ videoSrc, phrases, style, speakerStyles, animationPreset, showSpeakerBorders, phraseLaneOverrides, laneCount }: SubtitleCompositionProps) {
